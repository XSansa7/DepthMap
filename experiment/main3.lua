...
for epoch = 1, epochs do
    ...
    for sample = 1, TrainSize do
        ...
        tmp = network.output:mean()
        print(tmp)
        errors = errors + torch.csub(network.output, target):reshape(640*480):mean()
        print(errors)
