...
if config.localt == false then
    ...
    train_split = '/home/qc449/project/trainsplit.t7'
    test_split = '/home/qc449/project/testsplit.t7'
    N = 1449
...
function BuildPreP1()
    ...
    preprocessing1:add(nn.ReLU(true))
...
function BuildPreP2()
    ...
    preprocessing2:add(nn.SpatialConvolution(3, 96, 7, 9, 1, 1, 0, 0)
        :learningRate('weight', 0.1)
        :learningRate('bias', 0.1)) -- 150 110
    preprocessing2:add(nn.SpatialBatchNormalization(96))
    preprocessing2:add(nn.ReLU(true))
    preprocessing2:add(nn.SpatialMaxPooling(3, 3, 2, 2)) -- 96 74 55
    preprocessing2:add(nn.SpatialDropout(0.5))
...
function BuildPreP3()
    ...
    preprocessing3:add(nn.ReLU(true))
    preprocessing3:add(nn.SpatialMaxPooling(3, 3, 1, 1, 1, 1))
    preprocessing3:add(nn.SpatialDropout(0.5))
...
function BuildNetwork1()
    ...
    network1:add(nn.SpatialConvolution(3, 64, 5, 3, 1, 1)
        :learningRate('weight', 0.1)
        :learningRate('bias', 0.1)) -- 154 116
    network1:add(nn.SpatialBatchNormalization(64,1e-3))
    network1:add(nn.ReLU(true))
    -- network1:add(nn.SpatialMaxPooling(2,2,1,1,1,1))
    network1:add(nn.SpatialDropout(0.5))
    ...
    -- network1:add(nn.SpatialMaxPooling(2,2,1,1,1,1))
    network1:add(nn.SpatialDropout(0.5))
    network1:add(nn.SpatialConvolution(64, 128, 5, 5, 1, 1)
        :learningRate('weight', 0.1)
        :learningRate('bias', 0.1)) -- 150 112
    network1:add(nn.SpatialBatchNormalization(128,1e-3))
    network1:add(nn.ReLU(true))
    network1:add(nn.SpatialDropout(0.5))
    -- network1:add(nn.SpatialMaxPooling(2,2,1,1,1,1))
...
function BuildNetwork2()
    ...
    --layer 2.1
    network2:add(nn.SpatialConvolution(160, 160, 9, 9, 1, 1, 4, 4)
        :learningRate('weight', 0.1)
        :learningRate('bias', 0.1)) --160 74 55
    network2:add(nn.SpatialBatchNormalization(160,1e-3))
    network2:add(nn.ReLU(true))
    network2:add(nn.SpatialDropout(0.5))
    ...
    -- network2:add(nn.Dropout(0.3))
    --layer 2.5
    network2:add(nn.SpatialConvolution(64, 40, 5, 5, 1, 1, 2, 2)
        :learningRate('weight', 0.1)
        :learningRate('bias', 0.1)) --64 74 55
...
function BuildNetwork3()
    ...
    --layer 3.1
    network3:add(nn.SpatialConvolution(136, 64, 9, 9, 1, 1, 4, 4)
        :learningRate('weight', 0.1)
        :learningRate('bias', 0.1)) --64 147 109
    network3:add(nn.SpatialBatchNormalization(64,1e-3))
    network3:add(nn.ReLU(true))
    network3:add(nn.SpatialDropout(0.5))
    ...
    -- network3:add(nn.Dropout(0.3))
    --layer 3.4
    network3:add(nn.SpatialConvolution(64, 1, 5, 5, 1, 1, 2, 2)
        :learningRate('weight', 0.1)
        :learningRate('bias', 0.1)) --1 147 109
...
-- save model
network:clearState()
torch.save("/home/qc449/project/model_1217_2.t7",network)
