...
version = "depth14large_newdata"  -- momentum 0.1
owener = "qc449"
-- owener = "xj460"
...
if config.localt == false then
    train_image_path = '/scratch/' .. owener .. '/project/trainImage/'
    train_label_path =  '/scratch/' .. owener .. '/project/trainLabel/'
    train_depth_path =  '/scratch/' .. owener .. '/project/trainDepth/'
...
function BuildPreP1()
    ...
    preprocessing1:add(nn.SpatialConvolution(3,11,11,4,4,1,1))
    preprocessing1:add(nn.SpatialMaxPooling(2,2,2,2))
...
engine.hooks.onForward = function(state)
    ...
    correct1 = correct1 + sub_1 / (304*228)
    correct2 = correct2 + sub_2 / (304*228)
    correct3 = correct3 + sub_3 / (304*228)
end
